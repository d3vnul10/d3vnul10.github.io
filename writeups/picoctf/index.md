...
<!-- PicoCTF Profile Image -->
![PicoCTF Profile](/images/picoctf/pico_profile.png)

* * *

<h4 class="menu-header" id="picoctf">PicoCTF Writeups:</h4>

Explore PicoCTF challenges and learning exercises. This section features detailed writeups and solutions across **binary exploitation, web hacking, cryptography, and general CTF problem-solving**, documenting my practical approach and lessons learned.  

* * *
<h4 class="menu-header" id="picoctf">Writeups on **Medium**:</h4>
